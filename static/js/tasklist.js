$(function () {
    ...
    var _table = $table.dataTable($.extend(true, {}, CONSTANT.DATA_TABLES.DEFAULT_OPTION, {
        ajax: function (data, callback, settings) {//ajax配置为function,手动调用异步查询
            ...
            $.ajax({
                type: "GET",
                url: "/api/sparrow_crawl/site/o/task/list/",
                cache: false,  //禁用缓存
                data: param,    //传入已封装的参数
                dataType: "json",
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    console.log(data)
                    return '<a href="/api/sparrow_crawl/site/o/download/?filename=' + data + '&ext_type=xls" target="_blank"><i class="fa fa-paperclip"></i></a>';
                }
            },
            {
        ...
        "createdRow": function (row, data, index) {
            ...
            $('td', row).eq(7).append($btnView).append($btnDel);
